...
public class TestPerson2Servlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		out.printf("<style>#todaysRecommend { color: %s; }</style>%n", style);
		out.println("</head>");
		out.println("<body>");
		...
		out.println("<hr/>");
		out.printf("<h2>그럼 오늘 <span id='todaysRecommend'>%s</span> 어떠세요?</h2>%n", todaysRecommend);
		out.println("</body>");
		out.println("</html>");
